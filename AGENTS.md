...
- Consume Device Platform only through public REST/Webhook contracts and `@voicecan/server-client`. Never import Device Core or access Platform databases/storage credentials.
